...
<title>SEARCH</title>
<link href="search_search3.css" rel="stylesheet" type="text/css"/>
...
<div id="form-m">
    ...
    <form class="form" name = "Form" action="search2.php"   >
            ...
            <select name="status"  id = "status"  required>
                                    <option value="pub" id ="pub">บุคลทั่วไป</option>
                                    <option value="per" >           บุคลากร</option>
                                    <option value="stu" >           นิสิต</option>
                            </select>
            <div class="submit2">
            <img src="search.svg"  class = "img2" id = "img2">
            <a href="update.php"><button type="submit" id="login-button2" name = "send" value = "Edit"></button></a>
